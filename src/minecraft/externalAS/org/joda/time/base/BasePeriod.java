 ...
 */
package externalAS.org.joda.time.base;

import java.io.Serializable;

import externalAS.org.joda.time.Chronology;
import externalAS.org.joda.time.DateTimeUtils;
import externalAS.org.joda.time.Duration;
import externalAS.org.joda.time.DurationFieldType;
import externalAS.org.joda.time.MutablePeriod;
import externalAS.org.joda.time.PeriodType;
import externalAS.org.joda.time.ReadWritablePeriod;
import externalAS.org.joda.time.ReadableDuration;
import externalAS.org.joda.time.ReadableInstant;
import externalAS.org.joda.time.ReadablePeriod;
import externalAS.org.joda.time.chrono.ISOChronology;
import externalAS.org.joda.time.convert.ConverterManager;
import externalAS.org.joda.time.convert.PeriodConverter;
import externalAS.org.joda.time.field.FieldUtils;
import externalAS.org.joda.time.ReadablePartial;
 ...
 * The {@link externalAS.org.joda.time.ReadablePeriod} interface should be used when different
...
public abstract class BasePeriod
    ...
    /**
     * Creates a new period based on another using the {@link externalAS.org.joda.time.convert.ConverterManager}.
     *
